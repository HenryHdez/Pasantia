...
def mover_robot(ip, lista_destinos, tiempos_parada, num_intermedios=1):
    global x_actual, y_actual, theta_actual
    posiciones_robot = []

    # Generar lista de destinos con puntos intermedios
    lista_destinos, tiempos_parada = generar_destinos_con_intermedios(lista_destinos, tiempos_parada, num_intermedios)
